...
class _MySharesState extends State<MyShares> {
  ...
  Future<bool> _sellShares(int optionAmount, Share share) async {
    try {
      ...
      int amountGain = optionAmount * share.currentPrice;
      int initialAmount = optionAmount * share.price;
      successMessage = ((amountGain >= initialAmount) ? "+" : "-") +
          AbbreviatedNumberstringFormat.formatMarketCap(
              (amountGain - initialAmount).abs());
      ...
      children: [
        AlertDialog(
          ...
          content: isLoading
              ...
              : SizedBox(
                  width: 456, // Optional width for the ListView
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(
                                          right:
                                              rightPadding), // Add 12 units of right padding
                                      child: Text(
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.only(
                                        right:
                                            rightPadding), // Adds 12 units of right padding
